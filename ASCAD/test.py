...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        # ✅ 여기 경로를 정확히 아래처럼
        original_raw_traces_file = r"C:\test\ASCAD_data\ASCAD_data\ASCAD_databases\ATMega8515_raw_traces.h5"
        ...
        extract_traces(
            original_raw_traces_file,
            r"C:\test\ASCAD_data\ASCAD_fixed.h5",  # 결과 저장 위치도 절대경로로
            profiling_index,
            attack_index,
            target_points,
            profiling_desync,
